...
\begin{itemize}
  \item \textbf{Test driven REST API documentation}. For practitioners, we discuss a technique for producing example oriented REST API documentation as a byproduct from automated API test code.
  \item \textbf{Evolution of API documentation}. For practitioners, we discuss a technique for maintaining the evolution of API documentation as the API evolves.
  \item \textbf{Implications for future work}. We show a practical evidence of the viability of using interception to transform example API calls into API documentation. Researchers can leverage this technique for the documentation of other forms of APIs beyond REST.
\end{itemize}
